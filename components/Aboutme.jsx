...
const Aboutme = () => {
  return (
    <div className="max-h-screen lg:h-screen grid grid-cols-2 place-items-center justify-items-center gap-6 mx-4 xl:gap-2">
      <Cloud2
        className="absolute top-60 left-20 flex justify-start items-start opacity-10 z-10"
        width="600"
        height="600"
      />
      <Cloud2
      ...
      <Cloud3
        ...
        height="300"
      />
      <div className="bg-zinc-100/80 w-full h-full px-6 py-8 rounded-[64px] grid place-items-center justify-items-center">
        <h1 className="font-boldonse text-3xl text-violetMain font-bold text-center mb-8 max-w-xl z-10">
          Sobre Mim
        </h1>
        <p className="font-montserrat text-md text-center max-w-xl mb-4 z-10">
        ...
        <p className="font-montserrat text-md text-center max-w-xl mb-4">
        ...
        <p className="font-montserrat italic text-md text-center max-w-xl">
